...
SECRET_KEY = 'u2h$xjjmtguj1=++h@da4tgr!j+9127%5n6vtt#!7*_jer9rt$'
...
MIDDLEWARE = [
    ...
    'ecommerce.checkout.middleware.cart_item_middleware',
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'ecommerce.catalog.context_processors.categories',
            ],
        },
    },
]
