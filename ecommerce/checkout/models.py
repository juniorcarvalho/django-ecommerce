...
class CartItem(models.Model):
    cart_key = models.CharField('Chave', max_length=40, db_index=True)
    ...
    class Meta:
        ...
        # cria uma unique com mais de um campo
...
class Order(models.Model):
    ...
    status = models.IntegerField('Status',
                                 ...
                                 default=0,
                                 blank=True)
    payment_options = models.CharField('Opção de Pagamento',
...
models.signals.post_save.connect(post_save_cart_item,
                                 sender=CartItem,
